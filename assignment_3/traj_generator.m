...
if nargin > 2
    ...
    if(t == 0)
        ...
        x = caculate_poly(coffx(8*(t_index-2)+1:8*(t_index-1),1),scale,0);
        y = caculate_poly(coffy(8*(t_index-2)+1:8*(t_index-1),1),scale,0);
        z = caculate_poly(coffz(8*(t_index-2)+1:8*(t_index-1),1),scale,0);
        disp("t_index:"+num2str(t_index)+" scale:" + num2str(scale) + " x:"+ num2str(x) + " y:" + num2str(y) + " z:" + num2str(z))
        ...
        desired_state.vel = [vel_x;vel_y;vel_z];
        desired_state.acc = [acc_x;acc_y;acc_z];
        desired_state.yaw = 0;
        desired_state.yawdot = 0;
